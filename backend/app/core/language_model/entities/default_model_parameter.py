from .model_entity import DefaultModelParameterName, ModelParameterType,DefaultEmbeddingParmeterName
...
# 默认模型参数模板，用于减少YAML的配置，参数以OpenAI的模型接口作为标准
    DefaultEmbeddingParmeterName.DIMENSIONS:{
        "label": "维度",
        "type": ModelParameterType.INT,
        "help": "嵌入向量的维度数",
        "required": False,
    ...
    DefaultEmbeddingParmeterName.EMBEDDING_CTX_LENGTH:{
        "label": "嵌入长度",
        "type": ModelParameterType.INT,
        "help": "嵌入向量的长度",
        "required": False,
